package com.kiran.registrationlogin.dto;
...
public class UserDTO {
	 ...
	 email, String phone, @Pattern(regexp = "[0-9]{5}$", message = "Zip code wrong
	 format") String zip, @NotEmpty(message = "Required") String password,
